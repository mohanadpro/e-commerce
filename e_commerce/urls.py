...
from accounts.views import CustomLoginView, UserView
urlpatterns = [
    path('', root_route),
    ...
    path('dj-rest-auth/user/', UserView.as_view(), name='custom_user'),
    path('dj-rest-auth/', include('dj_rest_auth.urls')),
    path(
        'dj-rest-auth/registration/', include('dj_rest_auth.registration.urls')),
    path('check-user-admin/', include('accounts.urls')),
